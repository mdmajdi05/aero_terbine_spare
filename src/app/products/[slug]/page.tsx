...
interface ProductCategory extends NavCategory {}
    ...
    setError(null);
     ...
     request<{ success: boolean; data: NavCategoryTree }>('/nav-categories')
       .then((res) => {
         if (cancelled) return;
         setNavTree(res.data);
         const found = res.data.productCategories?.find((c) => c.slug === slug) as ProductCategory | undefined;
         if (found) {
           setCategory(found);
            ...
            <div className="mt-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {relatedCats.map((rc) => {
                  ...
                  return (
                    <Link key={rc.id} href={`/products/${rc.slug}`}
